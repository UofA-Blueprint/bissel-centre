          ...
          <div className="grid grid-cols-[1fr_auto_1fr] items-center h-20">
            ...
            <div className="flex justify-center self-stretch">
              <nav className="flex h-full">
                <a
                  href="/dashboard"
                  className="px-8 flex items-center text-lg border-t-4 border-t-transparent border-b-4 border-primary text-gray-900 font-bold"
                >
                  Dashboard
                </a>
                <a
                  href="#"
                  className="px-8 flex items-center text-lg border-t-4 border-t-transparent border-b-4 border-transparent text-gray-500 font-semibold hover:text-gray-700 hover:border-gray-300"
                >
                  Cards
                </a>
                <a
